...
//      print(parent.children);
      ...
      Element prnt = _dragElement.parent;

      int dragIndex = prnt.children.indexOf(_dragElement);

      // get the index of the element being dragged into
      int preIndex = prnt.children.indexOf(event.currentTarget);

//      prnt.insertAdjacentElement(where, element);
